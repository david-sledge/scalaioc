...
final class HttpRequestHandler(
    private val optionHandleDelete: (HttpServletRequest, HttpServletResponse) =>
      Unit = HttpRequestHandler.defaultDeleteHandler,
    private val optionHandleGet: (HttpServletRequest, HttpServletResponse) =>
      Unit = HttpRequestHandler.defaultGetHandler,
    private val optionHandlePost: (HttpServletRequest, HttpServletResponse) =>
      Unit = HttpRequestHandler.defaultPostHandler,
    private val optionHandlePut: (HttpServletRequest, HttpServletResponse) =>
      Unit = HttpRequestHandler.defaultPutHandler,
    private val optionHandleHead:
      (HttpServletRequest, HttpServletResponse) => Unit = null,
    private val optionHandleOptions:
      (HttpServletRequest, HttpServletResponse) => Unit = null,
    private val optionHandleTrace:
      (HttpServletRequest, HttpServletResponse) => Unit = null,
    private val getLastModified: (HttpServletRequest) => Long = (req) => -1,
    private val optionHandleRequest:
      (HttpServletRequest, HttpServletResponse) => Unit = null
  ) {
  ...
  private def maybeSetLastModified(resp: HttpServletResponse, lastModified: Long) = {
...
object HttpRequestHandler {
    ...
    def apply(optionHandleDelete: (HttpServletRequest, HttpServletResponse) =>
      Unit = HttpRequestHandler.defaultDeleteHandler,
      ...
      optionHandleRequest:
      (HttpServletRequest, HttpServletResponse) => Unit = null) =
        new HttpRequestHandler(optionHandleDelete, optionHandleGet,
            optionHandlePost, optionHandlePut, optionHandleHead,
            optionHandleOptions, optionHandleTrace, getLastModified,
            optionHandleRequest)
}
